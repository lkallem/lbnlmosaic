...
All diagrams automatically adapt to the site's theme (light/dark mode) and use LBNL brand colors for optimal integration with your research documentation.